...
<div class="min-h-[80vh] flex items-center justify-center px-4">
    <div class="w-full max-w-md bg-white rounded-2xl shadow-lg p-8">
        ...
        @if(\App\Models\SiteSetting::get('login_github_enabled', '0') === '1')
            <div class="mt-4 pt-4 border-t border-gray-200">
                <a href="/api/auth/github/redirect"
                   class="w-full flex items-center justify-center gap-2 py-2.5 bg-gray-900 text-white rounded-lg font-medium hover:bg-gray-800 transition">
